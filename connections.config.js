...
window.CONNECTIONS_CONFIG = {
  ...
  characters: [
    {
      id: 'lars', name: 'Lars', icon: 'images/lars.png',
      blurb: [
    ...
    {
      id: 'amara', name: 'Amara', icon: 'images/amara.png',
      blurb: [
    ...
    {
      id: 'noor', name: 'Noor', icon: 'images/noor.png',
      blurb: [
    ...
    {
      id: 'thomas', name: 'Thomas', icon: 'images/thomas.png',
      blurb: [
    ...
    {
      id: 'yasmine', name: 'Yasmine', icon: 'images/yasmine.png',
      blurb: [
    ...
    {
      id: 'bram', name: 'Bram', icon: 'images/bram.png',
      blurb: [
